...
namespace Kombats.Matchmaking.Infrastructure.Migrations
{
    ...
    [Migration("20260403000000_MoveToSchemaAndNormalizeDb")]
    partial class MoveToSchemaAndNormalizeDb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Kombats.Matchmaking.Infrastructure.Entities.OutboxMessageEntity", b =>
                {
                    ...
                    b.ToTable("matchmaking_outbox_messages", "matchmaking");
                });
            ...
            modelBuilder.Entity("Kombats.Matchmaking.Infrastructure.Entities.PlayerCombatProfileEntity", b =>
                {
                    ...
                    b.ToTable("player_combat_profiles", "matchmaking");
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.InboxState", b =>
                {
                    ...
                    b.ToTable("InboxState", "matchmaking");
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.OutboxMessage", b =>
                {
                    ...
                    b.ToTable("OutboxMessage", "matchmaking");
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.OutboxState", b =>
                {
                    ...
                    b.ToTable("OutboxState", "matchmaking");
                });
